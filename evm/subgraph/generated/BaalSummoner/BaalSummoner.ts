...
export class BaalSummoner__deployTokensResult {
  value0: Address;
  value1: Address;
...
export class BaalSummoner extends ethereum.SmartContract {
  ...
  deployTokens(
    _name: string,
    _symbol: string
  ): BaalSummoner__deployTokensResult {
    let result = super.call(
      "deployTokens",
    ...
    return new BaalSummoner__deployTokensResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_deployTokens(
    _name: string,
    _symbol: string
  ): ethereum.CallResult<BaalSummoner__deployTokensResult> {
    let result = super.tryCall(
      "deployTokens",
      "deployTokens(string,string):(address,address)",
      [ethereum.Value.fromString(_name), ethereum.Value.fromString(_symbol)]
    ...
    return ethereum.CallResult.fromValue(
      new BaalSummoner__deployTokensResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
