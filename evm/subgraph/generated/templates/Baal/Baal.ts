...
export class Baal__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class Baal extends ethereum.SmartContract {
  ...
  eip712Domain(): Baal__eip712DomainResult {
    ...
    return new Baal__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<Baal__eip712DomainResult> {
