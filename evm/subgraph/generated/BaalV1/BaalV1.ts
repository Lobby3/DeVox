...
export class BaalV1 extends ethereum.SmartContract {
  ...
  adminLock(): boolean {
    const result = super.call("adminLock", "adminLock():(bool)", []);

    return result[0].toBoolean();
  }

  try_adminLock(): ethereum.CallResult<boolean> {
    const result = super.tryCall("adminLock", "adminLock():(bool)", []);
    if (result.reverted) {
  ...
  avatar(): Address {
    const result = super.call("avatar", "avatar():(address)", []);

    return result[0].toAddress();
  }

  try_avatar(): ethereum.CallResult<Address> {
    const result = super.tryCall("avatar", "avatar():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  getGuard(): Address {
    const result = super.call("getGuard", "getGuard():(address)", []);

    return result[0].toAddress();
  }

  try_getGuard(): ethereum.CallResult<Address> {
    const result = super.tryCall("getGuard", "getGuard():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  governorLock(): boolean {
    const result = super.call("governorLock", "governorLock():(bool)", []);

    return result[0].toBoolean();
  }

  try_governorLock(): ethereum.CallResult<boolean> {
    const result = super.tryCall("governorLock", "governorLock():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  gracePeriod(): BigInt {
    const result = super.call("gracePeriod", "gracePeriod():(uint32)", []);

    return result[0].toBigInt();
  }

  try_gracePeriod(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("gracePeriod", "gracePeriod():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  guard(): Address {
    const result = super.call("guard", "guard():(address)", []);

    return result[0].toAddress();
  }

  try_guard(): ethereum.CallResult<Address> {
    const result = super.tryCall("guard", "guard():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  hashOperation(_transactions: Bytes): Bytes {
    const result = super.call("hashOperation", "hashOperation(bytes):(bytes32)", [
  ...
  isAdmin(shaman: Address): boolean {
    const result = super.call("isAdmin", "isAdmin(address):(bool)", [
  ...
  try_isAdmin(shaman: Address): ethereum.CallResult<boolean> {
    const result = super.tryCall("isAdmin", "isAdmin(address):(bool)", [
      ethereum.Value.fromAddress(shaman)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  isManager(shaman: Address): boolean {
    const result = super.call("isManager", "isManager(address):(bool)", [
      ethereum.Value.fromAddress(shaman)
    ]);
  ...
  try_isManager(shaman: Address): ethereum.CallResult<boolean> {
    const result = super.tryCall("isManager", "isManager(address):(bool)", [
      ethereum.Value.fromAddress(shaman)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  lootToken(): Address {
    const result = super.call("lootToken", "lootToken():(address)", []);

    return result[0].toAddress();
  }

  try_lootToken(): ethereum.CallResult<Address> {
    const result = super.tryCall("lootToken", "lootToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  managerLock(): boolean {
    const result = super.call("managerLock", "managerLock():(bool)", []);

    return result[0].toBoolean();
  }

  try_managerLock(): ethereum.CallResult<boolean> {
    const result = super.tryCall("managerLock", "managerLock():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  proposalCount(): BigInt {
    const result = super.call("proposalCount", "proposalCount():(uint32)", []);

    return result[0].toBigInt();
  }

  try_proposalCount(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("proposalCount", "proposalCount():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  quorumPercent(): BigInt {
    const result = super.call("quorumPercent", "quorumPercent():(uint256)", []);
  ...
  ragequitLock(): boolean {
    const result = super.call("ragequitLock", "ragequitLock():(bool)", []);

    return result[0].toBoolean();
  }

  try_ragequitLock(): ethereum.CallResult<boolean> {
    const result = super.tryCall("ragequitLock", "ragequitLock():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  shamans(param0: Address): BigInt {
    const result = super.call("shamans", "shamans(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_shamans(param0: Address): ethereum.CallResult<BigInt> {
    const result = super.tryCall("shamans", "shamans(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  sharesToken(): Address {
    const result = super.call("sharesToken", "sharesToken():(address)", []);

    return result[0].toAddress();
  }

  try_sharesToken(): ethereum.CallResult<Address> {
    const result = super.tryCall("sharesToken", "sharesToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  state(id: BigInt): i32 {
    const result = super.call("state", "state(uint32):(uint8)", [
      ethereum.Value.fromUnsignedBigInt(id)
    ]);
  ...
  try_state(id: BigInt): ethereum.CallResult<i32> {
    const result = super.tryCall("state", "state(uint32):(uint8)", [
      ethereum.Value.fromUnsignedBigInt(id)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  target(): Address {
    const result = super.call("target", "target():(address)", []);

    return result[0].toAddress();
  }

  try_target(): ethereum.CallResult<Address> {
    const result = super.tryCall("target", "target():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  totalLoot(): BigInt {
    const result = super.call("totalLoot", "totalLoot():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalLoot(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("totalLoot", "totalLoot():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  totalShares(): BigInt {
    const result = super.call("totalShares", "totalShares():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalShares(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("totalShares", "totalShares():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  votingNonces(param0: Address): BigInt {
    const result = super.call("votingNonces", "votingNonces(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  votingPeriod(): BigInt {
    const result = super.call("votingPeriod", "votingPeriod():(uint32)", []);

    return result[0].toBigInt();
  }

  try_votingPeriod(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("votingPeriod", "votingPeriod():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
