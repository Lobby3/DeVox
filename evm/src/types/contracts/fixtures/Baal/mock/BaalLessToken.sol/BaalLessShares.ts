...
export interface BaalLessSharesInterface extends utils.Interface {
  functions: {
...
export interface BaalLessShares extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaalLessSharesInterface;
