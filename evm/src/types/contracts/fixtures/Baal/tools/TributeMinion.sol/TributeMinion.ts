...
export type EscrowReleasedEvent = TypedEvent<
  [string, number, string, string, BigNumber],
  EscrowReleasedEventObject
>;

export type EscrowReleasedEventFilter = TypedEventFilter<EscrowReleasedEvent>;
...
export interface TributeMinion extends BaseContract {
  ...
  filters: {
    "EscrowReleased(address,uint32,address,address,uint256)"(
      baal?: PromiseOrValue<string> | null,
      proposalId?: null,
      applicant?: null,
      safe?: null,
      amount?: null
    ): EscrowReleasedEventFilter;
    EscrowReleased(
      baal?: PromiseOrValue<string> | null,
      proposalId?: null,
      applicant?: null,
