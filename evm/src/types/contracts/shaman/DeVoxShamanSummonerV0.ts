...
export interface DeVoxShamanSummonerV0Interface extends utils.Interface {
  functions: {
...
export interface DeVoxShamanSummonerV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeVoxShamanSummonerV0Interface;
