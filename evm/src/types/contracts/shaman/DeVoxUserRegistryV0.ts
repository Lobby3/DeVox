...
export interface DeVoxUserRegistryV0Interface extends utils.Interface {
  functions: {
...
export interface DeVoxUserRegistryV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeVoxUserRegistryV0Interface;
