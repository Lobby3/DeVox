...
export interface DeVoxBaalAndShamanSummonerV0Interface extends utils.Interface {
  functions: {
...
export interface DeVoxBaalAndShamanSummonerV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeVoxBaalAndShamanSummonerV0Interface;
