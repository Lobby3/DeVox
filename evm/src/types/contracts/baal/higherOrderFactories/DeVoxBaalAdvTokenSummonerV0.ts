...
export interface DeVoxBaalAdvTokenSummonerV0Interface extends utils.Interface {
  functions: {
...
export interface DeVoxBaalAdvTokenSummonerV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeVoxBaalAdvTokenSummonerV0Interface;
