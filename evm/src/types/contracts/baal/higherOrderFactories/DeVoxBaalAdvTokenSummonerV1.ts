...
export interface DeVoxBaalAdvTokenSummonerV1Interface extends utils.Interface {
  functions: {
...
export interface DeVoxBaalAdvTokenSummonerV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeVoxBaalAdvTokenSummonerV1Interface;
